...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_helper__ = __webpack_require__(196);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_auth_service__ = __webpack_require__(197);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_catch__ = __webpack_require__(269);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_catch___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_catch__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_toPromise__ = __webpack_require__(271);
...
var LoginPage = (function () {
    function LoginPage(navCtrl, authService, helper) {
        this.navCtrl = navCtrl;
...
LoginPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-login',template:/*ion-inline-start:"/home/ubuntu/workspace/src/pages/login/login.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Login</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n    <div ng-show="true">\n\n        <div class="list card cardprogram">\n            <form (ngSubmit)="attemptUserLogin()">\n            <div class="item item-body">\n                <label class="lorems lorems-content">\n                   Please login using your account information\n                </label>\n                <br/>\n                <br/>\n                <ion-item>\n                    <ion-input type="text" [(ngModel)]="loginData.email" name="Email" placeholder="Email" autocapitalize="none"></ion-input>\n                </ion-item>\n                <br>\n                <ion-item>\n                    <ion-input [(ngModel)]="loginData.password" type="password" name="description" placeholder="Contraseña"></ion-input>\n                </ion-item>\n                <br>\n                <input type="submit" class="button button-calm" value="LOGIN"/>\n                <br>\n                <br>\n                <ion-item class="menuitemusers" nav-transition="ios" nav-direction="forward" href="#/app/createaccount">\n                    REGISTER\n                </ion-item>\n                <ion-item class="menuitemhelp last" nav-transition="ios" nav-direction="forward" href="#/app/forgotpassword">\n                    FORGOT\n                </ion-item>\n\n            </div>\n            </form>\n        </div>\n\n    </div>\n\n    <div ng-show="false">\n        Hello {{ userEmail }} !\n    </div>\n</ion-content>'/*ion-inline-end:"/home/ubuntu/workspace/src/pages/login/login.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_4__providers_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_3__providers_helper__["a" /* HelperService */]])
], LoginPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic_native_dialogs__ = __webpack_require__(190);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_constants__ = __webpack_require__(267);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_dialogs__ = __webpack_require__(190);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_auth_service__ = __webpack_require__(197);
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["L" /* NgModule */])({
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_12__providers_helper__["a" /* HelperService */],
